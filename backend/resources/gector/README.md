...
and correction heads. The
`backend/speakflow/features/language_tools/infrastructure/grammar_model.py`
module constructs the architecture locally, so no separate `roberta-base`
checkout or runtime download is needed.
