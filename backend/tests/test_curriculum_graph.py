...
from plp.external_curriculum import (
...
from plp.retrieval import CurriculumRetriever
    ...
    def test_lexical_palette_never_fills_with_unrelated_or_duplicate_terms(self):
        rows = [
            SimpleNamespace(
                ...
                title="device",
                cefr_level="A2",
                attributes={"part_of_speech": "noun", "frequency_count": 100},
                topic_tags=["technology"],
            ),
            SimpleNamespace(
                id="device-verb",
                ...
                title="Device",
                cefr_level="A2",
                attributes={"part_of_speech": "verb", "frequency_count": 90},
                topic_tags=["technology"],
            ),
            SimpleNamespace(
                id="unrelated",
                ...
                title="onion",
                cefr_level="A2",
                attributes={"part_of_speech": "noun", "frequency_count": 1000},
                topic_tags=["food"],
            ),
        ]
        session = Mock()
    ...
    def test_music_and_history_use_related_reviewed_vocabulary_tags(self):
        rows = [
            ...
            SimpleNamespace(
                ...
                title="museum",
                cefr_level="B1",
                attributes={"part_of_speech": "noun", "frequency_count": 90},
                topic_tags=["culture"],
            ),
            SimpleNamespace(
                id="router",
    ...
    def test_lower_level_prerequisite_is_covered_by_placement_level(self):
        ...
        outline = build_outline(
            ...
            prerequisites_by_skill={
                "grammar.b1.ready": ["grammar.a2.foundation"]
            },
        )
        selected = {
            skill_id
