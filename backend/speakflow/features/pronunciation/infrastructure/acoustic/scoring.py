...
class Wav2Vec2ScoringMixin:
    ...
    def score(self, audio_path: str | Path, target_text: str) -> dict:
        ...
        return {
            ...
            "acoustic_flagged_phones": mistakes,
            "acoustic_uncertain_phones": uncertain,
            "calibration": {
                ...
                "orange_means": (
                    "uncertain; final orange phones may receive non-diagnostic "
                    "practice guidance, while red or cross-model contradictions "
                    "receive corrections"
                ),
                "quality_scale": (
