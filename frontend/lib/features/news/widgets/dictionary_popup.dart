// lib/features/news/widgets/dictionary_popup.dart
...
class DictionaryPopup extends ConsumerWidget {
  final String word;
        ...
        child: Stack(
          children: [
            Positioned(
              left: left,
              top: top,
              child: _LivePopupCard(
                word: word,
                lookup: lookup ?? ref.read(languageToolsApiProvider).lookupWord,
              ),
            ),
          ],
        ),
